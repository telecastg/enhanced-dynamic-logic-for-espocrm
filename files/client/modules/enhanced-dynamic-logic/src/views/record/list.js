...
Espo.define('enhanced-dynamic-logic:views/record/list', ['views/record/list','enhanced-dynamic-logic:dynamic-logic'], function (Dep,EnhancedDynamicLogic) {
    ...
    return Dep.extend({
        ...
        afterRender: function () {
            // execute the parent "afterRender" function
            Dep.prototype.afterRender.call(this); 
            // execute the custom afterRender commands
